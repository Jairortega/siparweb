...
class EntracliController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('entracli.i_entracli', compact('ivapvars', 'perfiles', 'usuarios'));
    } else {
...
*/
    ...
    $usuarios = Usuario::where('cc_user', '=', $cc_user)->get();
    if ($id_reserva > 0){
        return view('entracli.icr_entracli', compact('parqos', 'usuarios', 'reservas'));
    } else {
//        return $placa;
        return view('entracli.isr_entracli', compact('parqos', 'tipovehiculos', 'usuarios', 'reservas', 'id_parque'));           
    }
  }
