                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 style="color: #007bff; font-size: 20px; ">CREAR RESERVA (Ubicación Automática)</h4>
                        </div>
                        @csrf
                        {!! Form::open(['route' => ['t_reservas.store'], 'method' => 'POST', 'class' => 'card-body']) !!}
                            ...
                            <div class="form-group">
                                {!!Form::hidden('dir_origen', 'origen automatico', ['class'=>'form-control','onchange'=> 'origenMap();', 'placeholder'=>'Dirección Origen'])!!}
                            ...
                            <div class="form-group">
                                <p style= "color: 44b4c4; font-size: 18px; ">UBICACIÓN (Icono Rojo) -  DESTINO (Icono Verde)</p>
                                <p> </p>
