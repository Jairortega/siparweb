...
function origenMap(){
    ...
    gCoder.geocode(objInformation, fun_coderd);

    function fun_coderd(datos) {
        // console.log('DATOS: ' + datos);
        var coordestino = datos[0].geometry.location;
        document.getElementById('latitud_origen').value = coordestino;
        document.getElementById('longitud_origen').value = coordestino;
        ...
        document.getElementById('latitud_origen').value = Number(latio);
        document.getElementById('longitud_origen').value = Number(lngio);

        lat = Number(document.getElementById('latitud_origen').value);
        lon = Number(document.getElementById('longitud_origen').value);
