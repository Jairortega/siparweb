                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                          <table>
                             <td><h4 style="color: #007bff; font-size: 20px; ">CONSULTA SALIDA</h4></td>
                             <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                             @foreach ($servicios as $servi)
                               <td><p class= "text-primary"> &nbsp;&nbsp;&nbsp;CUPO DISPONIBLE {{ $servi->des_tvehiculo }}&nbsp;&nbsp;&nbsp;&nbsp;{{ $servi->dis_cupo }}</p></td>
                             @endforeach
                          </table>
                        </div>
                        ...
                        {!! Form::open(['route' => ['t_salidas.show', $sal->id_entrada], 'method' => 'GET', 'class' => 'card-body']) !!}
                            ...
                            <div class="form-group  text-danger h3">
                                {!!Form::label('vr_tot', 'Valor Pagado ')!!}
